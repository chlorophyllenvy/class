(function (root, factory) {
    ...
    templatizer["pages"]["home"] = function tmpl_pages_home() {
        return '<section class="page"><h1>Hey there wolves - on homepage</h1></section>';
    };

    // pages\howls.jade compiled template
    templatizer["pages"]["howls"] = function tmpl_pages_howls() {
        return '<section class="page"><h1>This is the howls page</h1><div data-hook="howls-container"></div></section>';
    };
